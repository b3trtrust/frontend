...
const ArbitratorsTopBar = ({ search, onSearch, showSaved, onToggleSaved, onOpenSidebar }: Props) => (
  <header className="fixed lg:relative top-0 left-0 right-0 z-20 bg-white/70 backdrop-blur-xl border-b border-orange-100 px-4 lg:px-8 py-4 flex items-center gap-4 shrink-0">
    ...
    <div className="flex-1 relative">
      ...
      <input
        ...
        placeholder="Search arbitrators, specialties..."
    ...
    <button
      ...
      title={showSaved ? "Show all" : "Show saved"}
...
export default ArbitratorsTopBar
